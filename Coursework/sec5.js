...
const movementDesc = movement.map(
  (mov, index) =>
...
const maxValue = [250, -100, 120, -140, 1220, 121, -22].reduce((acc, mov) =>
  acc > mov ? acc : mov
);
...
console.log(
  convertTitleCase(
    "This is the an but or on nice example DUDE BRO IN the CHAIR"
  )
);
